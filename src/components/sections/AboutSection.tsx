    ...
    <section className="px-4 border-x full-line-bottom relative">
      ...
      <div className="flex flex-col gap-4 py-4 font-mono text-sm ">
        <p className="tracking-wide">
          Hi there! I&apos;m Ronak Maheshwari — a full stack web developer from Pune
          Mahashtra, India. I love building stuffs and sharing cool
        ...
        <p className="tracking-wide">
          Right now, I&apos;m doing my Bachelor&apos;s in Computer Engineering from
          Wadia College, SavitriBai Phule University. I&apos;m learning lots of coding stuff
          and also making real projects to improve my skills.
        </p>
        <p className="tracking-wide">
          Besides coding, I enjoy writing tech blogs, listening songs, and
