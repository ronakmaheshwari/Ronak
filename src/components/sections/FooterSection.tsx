...
function FooterSection() {
  return (
    <section className='relative h-fit border-x full-line-bottom p-4'>
        ...
        <p className=" text-center font-mono text-sm text-balance text-muted-foreground">Built by <a className="font-semibold underline" href="https://ronak.10xdevs.me/" target="_blank" rel="noopener">Ronak Maheshwari</a>. The source code is available on {" "}<a className="font-semibold underline" href="https://github.com/ronakmaheshwari" target="_blank" rel="noopener">GitHub</a>.</p>
    </section>
  )
}
