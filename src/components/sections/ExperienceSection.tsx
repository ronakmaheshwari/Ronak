...
const experienceData = [
  {
    ...
    location: "Remote",
    href: " ",
    duration: "Intern  | Oct 2024 - Dec 2024",
    description: `A decentralized EdTech platform revolutionizing the way learners access content and credentials. Built on blockchain and powered by smart AI, it enables secure, transparent, and autonomous learning—empowering both educators and students globally.`,
    tasks: [
...
const freelanceData = [
  {
    ...
    location: "Remote",
    href: "https://www.6dresearch.org/",
    duration: "Part-Time  | May 2023 - June, 2024",
    description: `Edlock is a decentralized platform that guides users step-by-step to become sovereign crypto investors through intuitive design and practical, easy-to-implement advice.`,
    tasks: [
...
const educationData = [
  {
    duration: "2022 - 2026",
    institution: "Wadia College of Engineering",
    icon: GraduationCap,
    description:
      "Currently pursuing a Bachelor's degree in Computer Engineering (BE) at Wadia College.",
    points: [
  ...
  {
    duration: "2020 - 2022",
    institution: "RCM Junior College",
    icon: GraduationCap,
    description:
      "Studied Class 11 and 12 at RCM Junior College, an English medium institution under the Government board.",
    points: [
  ...
  },
  {
    ...
    icon: GraduationCap,
    description:
      "Completed Class 1 to 10 at Rosary High School, an English medium school affiliated with the SSC board.",
    points: [
      "Classes attended: 1th to 10th",
